...
- [ ] Add team logos: display NCAA team logos from ESPN CDN next to team names in bracket GameCards, comparison view, simulator, who-picked view, and champion display. Uses free ESPN CDN URLs (a.espncdn.com). Makes the bracket visually richer and easier to scan at a glance.
