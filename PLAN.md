...
- [ ] Add "Who Picked Whom" page: for a selected group, show every matchup with which members picked which team, counts, and percentages. Helps friends see consensus and contrarian picks at a glance. Linked from group page and dashboard nav.
