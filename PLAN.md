...
- [ ] Add bracket completion progress: show a progress bar on dashboard and group pages indicating how many of 63 picks are filled per bracket, with a "Complete" badge when all picks are in. Helps friends see who still needs to finish before lock time.
