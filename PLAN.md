...
- [ ] Add pick reminder banner: show an urgent banner on the dashboard when a user has incomplete brackets and lock time is within 24 hours. Color-coded (warning within 24h, error within 1h). Links to the bracket edit page. Helps friends avoid missing the deadline.
