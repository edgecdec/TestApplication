...
- [ ] Add persistent navigation bar: create a shared Navbar component shown on all authenticated pages with links to Dashboard, Groups, Stats, and profile. Currently each page has ad-hoc navigation buttons which is inconsistent. Include user greeting and logout button. Replaces per-page nav buttons.
