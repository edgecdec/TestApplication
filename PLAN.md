...
- [ ] Add user profile page: show a user's brackets with per-round score breakdown, groups they belong to, and join date. Clickable from leaderboards and group pages. Helps friends see each other's performance at a glance.
