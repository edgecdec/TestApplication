...
- [ ] Add champion pick and busted indicator to leaderboard: show each bracket's champion pick on the leaderboard row. Display a 💀 "Busted" badge if that team has been eliminated from the tournament (lost a game in results). Helps friends quickly see who picked whom to win it all and whose bracket is dead.
