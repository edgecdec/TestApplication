...
export default function SimulatorLeaderboard({ brackets, results, settings, regions }: Props) {
  const leaderboard = useMemo<LeaderboardEntry[]>(() => {
    ...
    const scores = brackets.map((b) => {
      ...
      return { ...score, championPick, busted, maxPossible: score.total + maxRemaining, finalFourPicks, semifinalPicks, correctPicks, totalResolved, streak, luckScore: null as number | null };
    });
    scores.sort((a, b) => {
